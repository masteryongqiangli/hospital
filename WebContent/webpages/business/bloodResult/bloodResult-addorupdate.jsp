	...
	<form id="bloodResult" method="post"
		...
		<table border="0" cellspacing="0" cellpadding="0" class="submit-table">
			...
			<tr class="firstTr">
				...
				<th><label>尿素：</label></th>
				<td><input id="UREA" class="easyui-validatebox"
					name="UREA"  value="${result.UREA }"  data-options=""  /></td>
			</tr>
			<tr class="firstTr">
				<th><label>乙肝表面抗原</label></th>
				<td><input id="hbsAg" class="easyui-validatebox" type="text"  
					name="hbsAg" value="${result.hbsAg }" data-options="" /></td>
				<th></th><td></td>
			</tr>
		</table>
	</form>
